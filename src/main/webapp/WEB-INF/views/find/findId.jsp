...
<body>
    <main class="main">
        ...
        <p style="font-size: 30px; text-align: center; margin: 0;">아이디 찾기</p>
        <div id="mainBox">
            <form action="/findId" id="box" method="post" onsubmit="return validate()">
                <div>
    ...
    <script src="/resource/js/inputId.js"></script>
