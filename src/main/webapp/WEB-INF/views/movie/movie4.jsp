...
<head>
	...
	<link rel="stylesheet" href="/resource/css/movie4.css">
</head>
<body>
	...
	<main class="main">
		...
		<div class="poster-main">
			...
			<div class="right">
				<!-- 제목 -->
				<div id="title">1980</div>

				<!-- 상세설명 -->
				<div id="explain">
					2024.03.27 개봉 | 99분 | 12세이상관람가 | 7,690명
				</div>
				...
				<!-- 내용 -->
				<div id="content">
					12·12 군사반란 불과 5개월 후<br>
                    세상이 무너지고 있었다!<br><br>

                    평생 중국 음식점 수타면을 뽑던 철수 할아버지는<br>
                    1980년 5월 17일 드디어 자기 음식점을 오픈한다.<br>
                    철수와 엄마, 아빠, 이모, 새신랑이 될 둘째 아들과 예비 신부까지<br>
                    대가족은 이제 행복한 꿈만 꾸면 된다고 생각하는데...<br>
				</div>
	...
	<script src="/resource/js/movie-4.js"></script>
